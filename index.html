...
<head>
		...
		<title>Casa Habano</title>
		<meta property="og:type" content="website">
		<meta property="og:title" content="Casa Habano">
...
<body>
	<section class="c">	
	 ...
	 <h2>The Best Cuban Cigars in Cozumel at La Casa del Habano.</h2>
	  <!-- <h3>Certified Cohiba, Montecristo, Romeo y Julieta, Partagas, Hoyo de Monterrey, Punch, H. Upmann, La Gloria Cubana, Quai D’Orsay, Fonseca, Por la Rañaga, H. Upmann, Cuaba, San Cristóbal de la Habana, Trinidad, Bolivar, Ramón de Allones, Sancho Panza. </h3> -->
	<h4>Authentic Cuban cigars</h4>
	<div id="social-platforms">
		<a class="btn btn-icon btn-facebook" href="https://www.facebook.com/LaCasaDelHabanoCozumel/"><i class=""><img src="img/facebook.png" width="100%" alt=""></i><span>La Casa del Habano</span></a>
	</div>
	</section>
</body>
</html>